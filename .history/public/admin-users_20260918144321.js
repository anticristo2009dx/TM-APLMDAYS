...
document.addEventListener('click', function (e) {
  ...
  if (btn) {
    ...
    document.getElementById('edit-user-rol').value = btn.dataset.rol || '1';
    document.getElementById('edit-user-correo').value = btn.dataset.correo || '';
    document.getElementById('edit-user-contrasena').value = '';
...
document.getElementById('edit-user-close')?.addEventListener('click', cerrarModalEdicion);
document.getElementById('edit-user-cancel')?.addEventListener('click', cerrarModalEdicion);