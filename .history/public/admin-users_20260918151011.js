...
document.addEventListener('click', function (e) {
  // Busca si el elemento presionado o su padre tiene la clase btn-editar
  const btn = e.target.closest('.btn-editar');

  if (btn) {
    e.preventDefault();

    // 1. Extraer los datos guardados en los atributos data-*
    ...
    // 2. Insertar los valores dentro de los campos del modal
