...
app.post('/auth', (req, res) => {
    ...
    if (usuarioIngresado && password) {
        connection.query('SELECT * FROM usuarios WHERE nombre = ?', [usuarioIngresado], async (error, results) => {
            ...
            // Comparar contraseña plana ingresada contra el hash guardado en la BD
...
app.post('/admin/usuarios', ensureRole(ROLES.ADMIN), (req, res) => {
    ...
    try {
        ...
        connection.query('SELECT id_usuario FROM usuarios WHERE nombre = ?', [nombre], async (error, filas) => {
            ...
            // Encriptar la contraseña con 8 rondas de hashing
            ...
            connection.query(
                ...
                (errorInsert, resultado) => {
                    ...
                    return res.json({
                        ok: true,
                        mensaje: 'Usuario creado y contraseña encriptada correctamente.',
                        usuario: {
